...
class Shader : public enable_shared_from_this<Shader>, public ResourceBase
{
public:
	friend struct Pass;
...
public:
	...
	void Draw(wstring technique, UINT pass, UINT vertexCount, UINT startVertexLocation = 0);
	void DrawIndexed(wstring technique, UINT pass, UINT indexCount, UINT startIndexLocation = 0, INT baseVertexLocation = 0);
	void DrawInstanced(wstring technique, UINT pass, UINT vertexCountPerInstance, UINT instanceCount, UINT startVertexLocation = 0, UINT startInstanceLocation = 0);
	void DrawIndexedInstanced(wstring technique, UINT pass, UINT indexCountPerInstance, UINT instanceCount, UINT startIndexLocation = 0, INT baseVertexLocation = 0, UINT startInstanceLocation = 0);

	void Dispatch(wstring technique, UINT pass, UINT x, UINT y, UINT z);
...
private:
	...
	map<wstring,Technique> _techniques;

public:
	void PushTransformData(const TransformDesc& desc);
	void PushGlobalData(const GlobalDesc& desc);
